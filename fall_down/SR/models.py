...
class FeatureExtractor(nn.Module):
    def __init__(self, cnn, feature_layer=11):
        ...
        self.features = nn.Sequential(*list(cnn.features.children())[:(feature_layer+1)]) # use first 11 layers
        # features(low feature which include abundant high frequency texture info)
